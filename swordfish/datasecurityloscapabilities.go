...
// AuthenticationType is The enumeration literals shall specify authentication
// algorithms.
type AuthenticationType string

const (
	// NoneAuthenticationType This enumeration literal specifies No authentication.
	NoneAuthenticationType AuthenticationType = "None"
	// PKIAuthenticationType This enumeration literal specifies a Public Key
	...
	// TicketAuthenticationType This enumeration literal specifies Ticket-based
	...
	// PasswordAuthenticationType This enumeration literal specifies
...
func ListReferencedDataSecurityLoSCapabilitiess(c common.Client, link string) ([]*DataSecurityLoSCapabilities, error) {

...
//
// 2025.3 - #LogEntry.v1_20_0.LogEntry
...
func (l *LogEntry) OriginOfCondition(client Client) (*Entity, error) {
	if l.originOfCondition == "" {
		return nil, nil
	}
	return GetObject[Entity](client, l.originOfCondition)
}

// RelatedItem gets the RelatedItem linked resources.
func (l *LogEntry) RelatedItem(client Client) ([]*Entity, error) {
	return GetObjects[Entity](client, l.relatedItem)
}

// RelatedLogEntries gets the RelatedLogEntries linked resources.
func (l *LogEntry) RelatedLogEntries(client Client) ([]*LogEntry, error) {
	return GetObjects[LogEntry](client, l.relatedLogEntries)
}

...
func (a *AttributeRegistry) UnmarshalJSON(b []byte) error {
...
func (a *AttributeRegistry) Update() error {
...
type Dependency struct {
	...
	// evaluates to 'true'.
	MapToValue *float64 `json:",omitempty"`
}
...
type MapFrom struct {
	...
	// expression.
	MapFromValue *float64 `json:",omitempty"`

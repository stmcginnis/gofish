...
// SPDMGetSignedMeasurements shall generate a cryptographic signed statement over the given
...
// TPMGetSignedMeasurements shall generate a cryptographic signed statement over the given
...
// 'TPM'.
// certificate - This parameter shall contain the reference to the certificate
// installed on the TPM that represents the TPM's attestation key for the
// 'signHandle' parameter of the 'TPM2_Quote' command defined in the Trusted
// Platform Module Library Specification.
// nonce - This parameter shall contain a set of bytes as a hex-encoded string
// that is signed with the measurements. Services shall reject the action
// request if the number of bytes provided is larger than the value specified
// by the 'NonceSizeBytesMaximum' property in the 'TPM' property. If not
// provided by the client, the service shall generate the nonce. The value
// should be unique and generated using a random or a pseudo-random generator.
// The service shall send this value to the TPM in the 'qualifyingData'
// parameter of the 'TPM2_Quote' command defined in the Trusted Platform Module
// Library Specification.
// pCRSelection - This parameter shall contain a Base64-encoded string, with
// padding characters, of the 'TPML_PCR_SELECTION' object as defined by the
// Trusted Platform Module Library Specification, that identifies the PCRs to
// sign. The service shall send this value to the TPM in the 'PCRselect'
// parameter of the 'TPM2_Quote' command defined in the Trusted Platform Module
// Library Specification.
// scheme - This parameter shall contain a Base64-encoded string, with padding
// characters, of the 'TPMT_SIG_SCHEME' object as defined in the Trusted
// Platform Module Library Specification, that identifies the signing scheme to
// use for the TPM attestation key. The service shall send this value to the
// TPM in the 'inScheme' parameter of the 'TPM2_Quote' command defined in the
// Trusted Platform Module Library Specification.
func (c *ComponentIntegrity) TPMGetSignedMeasurements(certificate string, nonce string, pCRSelection string, scheme string) (*TPMGetSignedMeasurementsResponse, error) {
	payload := make(map[string]any)
	payload["Certificate"] = certificate
	payload["Nonce"] = nonce
	payload["PCRSelection"] = pCRSelection
	payload["Scheme"] = scheme

	resp, err := c.PostWithResponse(c.tPMGetSignedMeasurementsTarget, payload)
	if err != nil {
		return nil, err
	}
	defer resp.Body.Close()
...
func (c *ComponentIntegrity) ComponentsProtected(client common.Client) ([]*common.Entity, error) {
	return common.GetObjects[common.Entity](client, c.componentsProtected)
}
...
func (c *CommonAuthInfo) UnmarshalJSON(b []byte) error {
	...
	var tmp struct {
		temp
		ComponentCertificate common.Link `json:"componentCertificate"`
	}
...
func (c *CommonAuthInfo) ComponentCertificate(client common.Client) (*Certificate, error) {
	if c.componentCertificate == "" {
		return nil, nil
	}
	return common.GetObject[Certificate](client, c.componentCertificate)
}
...
func (s *SPDMGetSignedMeasurementsResponse) UnmarshalJSON(b []byte) error {
	...
	var tmp struct {
		temp
		Certificate common.Link `json:"certificate"`
	}
...
func (s *SPDMGetSignedMeasurementsResponse) Certificate(client common.Client) (*Certificate, error) {
	if s.certificate == "" {
		return nil, nil
	}
	return common.GetObject[Certificate](client, s.certificate)
}
...
func (s *SPDMinfo) UnmarshalJSON(b []byte) error {
	...
	var tmp struct {
		temp
		Requester common.Link `json:"requester"`
	}
...
func (s *SPDMinfo) Requester(client common.Client) (*common.Entity, error) {
	if s.requester == "" {
		return nil, nil
	}
	return common.GetObject[common.Entity](client, s.requester)
}
...
func (s *SPDMrequesterAuth) UnmarshalJSON(b []byte) error {
	...
	var tmp struct {
		temp
		ProvidedCertificate common.Link `json:"providedCertificate"`
	}
...
func (s *SPDMrequesterAuth) ProvidedCertificate(client common.Client) (*Certificate, error) {
	if s.providedCertificate == "" {
		return nil, nil
	}
	return common.GetObject[Certificate](client, s.providedCertificate)
}
...
// ComponentCertificate gets the ComponentCertificate linked resource.
func (s *SPDMresponderAuth) ComponentCertificate(client common.Client) (*Certificate, error) {
	if s.componentCertificate == "" {
		return nil, nil
	}
	return common.GetObject[Certificate](client, s.componentCertificate)
}
...
// ComponentCertificate gets the ComponentCertificate linked resource.
func (t *TPMauth) ComponentCertificate(client common.Client) (*Certificate, error) {
	if t.componentCertificate == "" {
		return nil, nil
	}
	return common.GetObject[Certificate](client, t.componentCertificate)
}

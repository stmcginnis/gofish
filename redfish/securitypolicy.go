...
func (s *SPDMPolicy) UnmarshalJSON(b []byte) error {
	...
	var tmp struct {
		temp
		RevokedCertificates common.Link `json:"revokedCertificates"`
		TrustedCertificates common.Link `json:"trustedCertificates"`
	}
...
func (s *SPDMPolicy) RevokedCertificates(client common.Client) ([]*Certificate, error) {
	if s.revokedCertificates == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[Certificate](client, s.revokedCertificates)
}

// TrustedCertificates gets the TrustedCertificates collection.
func (s *SPDMPolicy) TrustedCertificates(client common.Client) ([]*Certificate, error) {
	if s.trustedCertificates == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[Certificate](client, s.trustedCertificates)
}
...
// RevokedCertificates gets the RevokedCertificates collection.
func (t *TLSPolicy) RevokedCertificates(client common.Client) ([]*Certificate, error) {
	if t.revokedCertificates == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[Certificate](client, t.revokedCertificates)
}

// TrustedCertificates gets the TrustedCertificates collection.
func (t *TLSPolicy) TrustedCertificates(client common.Client) ([]*Certificate, error) {
	if t.trustedCertificates == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[Certificate](client, t.trustedCertificates)
}

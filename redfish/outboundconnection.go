...
func (o *OutboundConnection) UnmarshalJSON(b []byte) error {
	...
	type oLinks struct {
		Session common.Link `json:"Session"`
	}
	var tmp struct {
		temp
		Links              oLinks
...
func (o *OutboundConnection) Session(client common.Client) (*Session, error) {
	if o.session == "" {
		return nil, nil
	}
	return common.GetObject[Session](client, o.session)
}

// Certificates gets the Certificates collection.
func (o *OutboundConnection) Certificates(client common.Client) ([]*Certificate, error) {
	if o.certificates == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[Certificate](client, o.certificates)
}

// ClientCertificates gets the ClientCertificates collection.
func (o *OutboundConnection) ClientCertificates(client common.Client) ([]*Certificate, error) {
	if o.clientCertificates == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[Certificate](client, o.clientCertificates)
}

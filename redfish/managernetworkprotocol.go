...
// UnmarshalJSON unmarshals a ManagerNetworkProtocol object from the raw JSON.
func (m *ManagerNetworkProtocol) UnmarshalJSON(b []byte) error {
	type temp ManagerNetworkProtocol
	var tmp struct {
		temp
	}
	...
	*m = ManagerNetworkProtocol(tmp.temp)
...
func (m *ManagerNetworkProtocol) Update() error {
...
func GetManagerNetworkProtocol(c common.Client, uri string) (*ManagerNetworkProtocol, error) {
	return common.GetObject[ManagerNetworkProtocol](c, uri)
}

// ListReferencedManagerNetworkProtocols gets the collection of ManagerNetworkProtocol from
// a provided reference.
func ListReferencedManagerNetworkProtocols(c common.Client, link string) ([]*ManagerNetworkProtocol, error) {
	return common.GetCollectionObjects[ManagerNetworkProtocol](c, link)
}
...
func (h *HTTPSProtocolSettings) Certificates(client common.Client) ([]*Certificate, error) {
	if h.certificates == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[Certificate](client, h.certificates)
}

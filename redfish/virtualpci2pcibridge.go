...
func (v *VirtualPCI2PCIBridge) Update() error {
...
func GetVirtualPCI2PCIBridge(c common.Client, uri string) (*VirtualPCI2PCIBridge, error) {
	return common.GetObject[VirtualPCI2PCIBridge](c, uri)
}

// ListReferencedVirtualPCI2PCIBridges gets the collection of VirtualPCI2PCIBridge from
// a provided reference.
func ListReferencedVirtualPCI2PCIBridges(c common.Client, link string) ([]*VirtualPCI2PCIBridge, error) {
	return common.GetCollectionObjects[VirtualPCI2PCIBridge](c, link)
}

// Endpoints gets the Endpoints linked resources.
func (v *VirtualPCI2PCIBridge) Endpoints(client common.Client) ([]*Endpoint, error) {
	return common.GetObjects[Endpoint](client, v.endpoints)
}

// Port gets the Port linked resource.
func (v *VirtualPCI2PCIBridge) Port(client common.Client) (*Port, error) {
	if v.port == "" {
		return nil, nil
	}

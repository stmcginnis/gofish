...
//
// 2025.3 - #CertificateEnrollment.v1_0_0.CertificateEnrollment
...
func (c *CertificateEnrollment) UnmarshalJSON(b []byte) error {
	...
	type cLinks struct {
		CACertificates              common.Links `json:"CACertificates"`
		EnrolledCertificate         common.Link  `json:"EnrolledCertificate"`
		EnrolledCertificateLocation common.Link  `json:"EnrolledCertificateLocation"`
	}
	var tmp struct {
		temp
		Links cLinks
...
func GetCertificateEnrollment(c common.Client, uri string) (*CertificateEnrollment, error) {
	return common.GetObject[CertificateEnrollment](c, uri)
}

// ListReferencedCertificateEnrollments gets the collection of CertificateEnrollment from
// a provided reference.
func ListReferencedCertificateEnrollments(c common.Client, link string) ([]*CertificateEnrollment, error) {
	return common.GetCollectionObjects[CertificateEnrollment](c, link)
}

// CACertificates gets the CACertificates linked resources.
func (c *CertificateEnrollment) CACertificates(client common.Client) ([]*Certificate, error) {
	return common.GetObjects[Certificate](client, c.cACertificates)
}

// EnrolledCertificate gets the EnrolledCertificate linked resource.
func (c *CertificateEnrollment) EnrolledCertificate(client common.Client) (*Certificate, error) {
	if c.enrolledCertificate == "" {
		return nil, nil
	}
	return common.GetObject[Certificate](client, c.enrolledCertificate)
}

// EnrolledCertificateLocation gets the EnrolledCertificateLocation linked resource.
func (c *CertificateEnrollment) EnrolledCertificateLocation(client common.Client) (*CertificateLocations, error) {
	if c.enrolledCertificateLocation == "" {
		return nil, nil
	}
	return common.GetObject[CertificateLocations](client, c.enrolledCertificateLocation)
}
...
type CSRParameters struct {
	...
	City string
	// CommonName shall contain the fully qualified domain name of the component to
	// secure, as defined by the RFC5280 'commonName' attribute.
	CommonName string

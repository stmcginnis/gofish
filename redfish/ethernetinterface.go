...
func (e *EthernetInterface) UnmarshalJSON(b []byte) error {
	...
	type eLinks struct {
		AffiliatedInterfaces   common.Links `json:"AffiliatedInterfaces"`
		Chassis                common.Link  `json:"Chassis"`
		Endpoints              common.Links `json:"Endpoints"`
		HostInterface          common.Link  `json:"HostInterface"`
		...
		RelatedInterfaces      common.Links `json:"RelatedInterfaces"`
	}
	var tmp struct {
		temp
		Links eLinks
...
func (e *EthernetInterface) AffiliatedInterfaces(client common.Client) ([]*EthernetInterface, error) {
	return common.GetObjects[EthernetInterface](client, e.affiliatedInterfaces)
}

// Chassis gets the Chassis linked resource.
func (e *EthernetInterface) Chassis(client common.Client) (*Chassis, error) {
	if e.chassis == "" {
		return nil, nil
	}
	return common.GetObject[Chassis](client, e.chassis)
}

// Endpoints gets the Endpoints linked resources.
func (e *EthernetInterface) Endpoints(client common.Client) ([]*Endpoint, error) {
	return common.GetObjects[Endpoint](client, e.endpoints)
}

// HostInterface gets the HostInterface linked resource.
func (e *EthernetInterface) HostInterface(client common.Client) (*HostInterface, error) {
	if e.hostInterface == "" {
		return nil, nil
	}
	return common.GetObject[HostInterface](client, e.hostInterface)
}

// NetworkDeviceFunction gets the NetworkDeviceFunction linked resource.
func (e *EthernetInterface) NetworkDeviceFunction(client common.Client) (*NetworkDeviceFunction, error) {
	if e.networkDeviceFunction == "" {
		return nil, nil
	}
	return common.GetObject[NetworkDeviceFunction](client, e.networkDeviceFunction)
}

// NetworkDeviceFunctions gets the NetworkDeviceFunctions linked resources.
func (e *EthernetInterface) NetworkDeviceFunctions(client common.Client) ([]*NetworkDeviceFunction, error) {
	return common.GetObjects[NetworkDeviceFunction](client, e.networkDeviceFunctions)
}

// Ports gets the Ports linked resources.
func (e *EthernetInterface) Ports(client common.Client) ([]*Port, error) {
	return common.GetObjects[Port](client, e.ports)
}

// RelatedInterfaces gets the RelatedInterfaces linked resources.
func (e *EthernetInterface) RelatedInterfaces(client common.Client) ([]*EthernetInterface, error) {
	return common.GetObjects[EthernetInterface](client, e.relatedInterfaces)
}

// VLANs gets the VLANs collection.
func (e *EthernetInterface) VLANs(client common.Client) ([]*VLanNetworkInterface, error) {
	if e.vLANs == "" {
		return nil, nil
	}

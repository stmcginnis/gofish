...
func (p *ProcessorMetrics) Update() error {
...
func (p *ProcessorMetrics) ClearCurrentPeriod() error {
	payload := make(map[string]any)
	return p.Post(p.clearCurrentPeriodTarget, payload)
}
...
// CurrentPeriod shall describe the cache memory metrics since last system reset
...
// LifeTime shall describe the cache memory metrics since manufacturing for a
// processor.

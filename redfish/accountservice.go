...
//
// 2025.1 - #AccountService.v1_18_0.AccountService
...
type AccountService struct {
	...
	//
	// Version added: v1.8.0
	RestrictedPrivileges []common.PrivilegeType
...
func (a *AccountService) UnmarshalJSON(b []byte) error {
	...
	var tmp struct {
		temp
		Accounts                           common.Link `json:"accounts"`
		AdditionalExternalAccountProviders common.Link `json:"additionalExternalAccountProviders"`
		PrivilegeMap                       common.Link `json:"privilegeMap"`
		Roles                              common.Link `json:"roles"`
	}
...
func ListReferencedAccountServices(c common.Client, link string) ([]*AccountService, error) {
	return common.GetCollectionObjects[AccountService](c, link)
}

// Accounts gets the Accounts collection.
func (a *AccountService) Accounts(client common.Client) ([]*ManagerAccount, error) {
	if a.accounts == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[ManagerAccount](client, a.accounts)
}

// AdditionalExternalAccountProviders gets the AdditionalExternalAccountProviders collection.
func (a *AccountService) AdditionalExternalAccountProviders(client common.Client) ([]*ExternalAccountProvider, error) {
	if a.additionalExternalAccountProviders == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[ExternalAccountProvider](client, a.additionalExternalAccountProviders)
}

// PrivilegeMap gets the PrivilegeMap linked resource.
func (a *AccountService) PrivilegeMap(client common.Client) (*common.PrivilegeRegistry, error) {
	if a.privilegeMap == "" {
		return nil, nil
	}
	return common.GetObject[common.PrivilegeRegistry](client, a.privilegeMap)
}

// Roles gets the Roles collection.
func (a *AccountService) Roles(client common.Client) ([]*Role, error) {
	if a.roles == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[Role](client, a.roles)
}
...
func (c *ClientCertificate) Certificates(client common.Client) ([]*Certificate, error) {
	if c.certificates == "" {
		return nil, nil
	}
...
// Certificates gets the Certificates collection.
func (s *SecurID) Certificates(client common.Client) ([]*Certificate, error) {
	if s.certificates == "" {
		return nil, nil
	}

...
func (o *OperatingSystem) UnmarshalJSON(b []byte) error {
	...
	var tmp struct {
		temp
		Links           oLinks
		Applications    common.Link `json:"applications"`
		ContainerImages common.Link `json:"containerImages"`
		Containers      common.Link `json:"containers"`
	}
...
func (o *OperatingSystem) Update() error {
...
func (o *OperatingSystem) SoftwareImage(client common.Client) (*SoftwareInventory, error) {
	if o.softwareImage == "" {
		return nil, nil
	}
	return common.GetObject[SoftwareInventory](client, o.softwareImage)
}

// Applications gets the Applications collection.
func (o *OperatingSystem) Applications(client common.Client) ([]*Application, error) {
	if o.applications == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[Application](client, o.applications)
}

// ContainerImages gets the ContainerImages collection.
func (o *OperatingSystem) ContainerImages(client common.Client) ([]*ContainerImage, error) {
	if o.containerImages == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[ContainerImage](client, o.containerImages)
}

// Containers gets the Containers collection.
func (o *OperatingSystem) Containers(client common.Client) ([]*Container, error) {
	if o.containers == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[Container](client, o.containers)
}

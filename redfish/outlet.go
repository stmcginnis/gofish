...
// PowerControl shall control the power state of the outlet.
// powerState - This parameter shall contain the desired power state of the
// outlet.
func (o *Outlet) PowerControl(powerState common.PowerState) error {
...
// outlet.
func (o *Outlet) ResetMetrics() error {
	payload := make(map[string]any)
	return o.Post(o.resetMetricsTarget, payload)
}

// BranchCircuit gets the BranchCircuit linked resource.
func (o *Outlet) BranchCircuit(client common.Client) (*Circuit, error) {
	if o.branchCircuit == "" {
		return nil, nil
	}
	return common.GetObject[Circuit](client, o.branchCircuit)
}

// Chassis gets the Chassis linked resources.
func (o *Outlet) Chassis(client common.Client) ([]*Chassis, error) {
	return common.GetObjects[Chassis](client, o.chassis)
}

// DistributionCircuits gets the DistributionCircuits linked resources.
func (o *Outlet) DistributionCircuits(client common.Client) ([]*Circuit, error) {
	return common.GetObjects[Circuit](client, o.distributionCircuits)
}

// PowerSupplies gets the PowerSupplies linked resources.
func (o *Outlet) PowerSupplies(client common.Client) ([]*PowerSupply, error) {
	return common.GetObjects[PowerSupply](client, o.powerSupplies)
}

...
func (n *NetworkDeviceFunctionMetrics) UnmarshalJSON(b []byte) error {
	...
	type nActions struct {
		ResetMetrics common.ActionTarget `json:"#NetworkDeviceFunctionMetrics.ResetMetrics"`
	}
	var tmp struct {
		temp
		Actions nActions
...
func (n *NetworkDeviceFunctionMetrics) Update() error {
...
// device.
func (n *NetworkDeviceFunctionMetrics) ResetMetrics() error {
	payload := make(map[string]any)
	return n.Post(n.resetMetricsTarget, payload)
}

// EthernetMetric shall describe the Ethernet-related network function metrics.
type EthernetMetric struct {
...
// FibreChannelMetric shall describe the Fibre Channel-related network function
// metrics.
type FibreChannelMetric struct {

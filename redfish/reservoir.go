...
func (r *Reservoir) Assembly(client common.Client) (*Assembly, error) {
	if r.assembly == "" {
		return nil, nil
	}
	return common.GetObject[Assembly](client, r.assembly)
}

// Filters gets the Filters collection.
func (r *Reservoir) Filters(client common.Client) ([]*Filter, error) {
	if r.filters == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[Filter](client, r.filters)
}

...
func (c *CoolantConnector) UnmarshalJSON(b []byte) error {
	...
	type cActions struct {
		ValveControl common.ActionTarget `json:"#CoolantConnector.ValveControl"`
	}
	type cLinks struct {
		ConnectedChassis     common.Links `json:"ConnectedChassis"`
		ConnectedCoolingLoop common.Link  `json:"ConnectedCoolingLoop"`
		ConnectedCoolingUnit common.Link  `json:"ConnectedCoolingUnit"`
	}
	var tmp struct {
		temp
		Actions cActions
...
// ValveControl shall set the operating state of the coolant connector
...
func (c *CoolantConnector) ValveControl(valveState ValveState, valveStateReason ValveStateReason) error {
	payload := make(map[string]any)
	payload["ValveState"] = valveState
	payload["ValveStateReason"] = valveStateReason
	return c.Post(c.valveControlTarget, payload)
}

// ConnectedChassis gets the ConnectedChassis linked resources.
func (c *CoolantConnector) ConnectedChassis(client common.Client) ([]*Chassis, error) {
	return common.GetObjects[Chassis](client, c.connectedChassis)
}

// ConnectedCoolingLoop gets the ConnectedCoolingLoop linked resource.
func (c *CoolantConnector) ConnectedCoolingLoop(client common.Client) (*CoolingLoop, error) {
	if c.connectedCoolingLoop == "" {
		return nil, nil
	}
	return common.GetObject[CoolingLoop](client, c.connectedCoolingLoop)
}

// ConnectedCoolingUnit gets the ConnectedCoolingUnit linked resource.
func (c *CoolantConnector) ConnectedCoolingUnit(client common.Client) (*CoolingUnit, error) {
	if c.connectedCoolingUnit == "" {
		return nil, nil
	}
	return common.GetObject[CoolingUnit](client, c.connectedCoolingUnit)
}

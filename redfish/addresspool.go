...
func (a *AddressPool) Update() error {
...
func (a *AddressPool) Endpoints(client common.Client) ([]*Endpoint, error) {
	return common.GetObjects[Endpoint](client, a.endpoints)
}

// Zones gets the Zones linked resources.
func (a *AddressPool) Zones(client common.Client) ([]*Zone, error) {
	return common.GetObjects[Zone](client, a.zones)
}
...
// AddressPoolEthernet shall contain the Ethernet-related properties for an address pool.
...
// AddressPoolGenZ shall contain Gen-Z related properties for an address pool.
type AddressPoolGenZ struct {

...
func (c *CoolingLoop) Chassis(client common.Client) (*Chassis, error) {
	if c.chassis == "" {
		return nil, nil
	}
	return common.GetObject[Chassis](client, c.chassis)
}

// Facility gets the Facility linked resource.
func (c *CoolingLoop) Facility(client common.Client) (*Facility, error) {
	if c.facility == "" {
		return nil, nil
	}
...
func (c *CoolingLoop) ManagedBy(client common.Client) ([]*Manager, error) {
	return common.GetObjects[Manager](client, c.managedBy)
}

// PrimaryCoolantConnectors gets the PrimaryCoolantConnectors collection.
func (c *CoolingLoop) PrimaryCoolantConnectors(client common.Client) ([]*CoolantConnector, error) {
...
func (c *CoolingLoop) SecondaryCoolantConnectors(client common.Client) ([]*CoolantConnector, error) {

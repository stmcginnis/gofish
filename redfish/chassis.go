...
type Chassis struct {
	...
	Doors Doors
	// Drives shall contain a link to a resource collection of type
	// 'DriveCollection'.
	//
	...
	// 'ProcessorCollection' that represents processors in this chassis that belong
	...
	// linkedPCIeDevices are the URIs for PCIeDevices.
	...
	poweredBy []string
	// linkedProcessors are the URIs for Processors.
	linkedProcessors []string
...
func (c *Chassis) UnmarshalJSON(b []byte) error {
	...
	type cLinks struct {
		AutomationNodes       common.Links `json:"AutomationNodes"`
		Cables                common.Links `json:"Cables"`
		ComputerSystems       common.Links `json:"ComputerSystems"`
		ConnectedCoolingLoops common.Links `json:"ConnectedCoolingLoops"`
		ContainedBy           common.Link  `json:"ContainedBy"`
		Contains              common.Links `json:"Contains"`
		CooledBy              common.Links `json:"CooledBy"`
		CoolingUnits          common.Links `json:"CoolingUnits"`
		Drives                common.Links `json:"Drives"`
		DrivesCount           int          `json:"Drives@odata.count"`
		Facility              common.Link  `json:"Facility"`
		Fans                  common.Links `json:"Fans"`
		ManagedBy             common.Links `json:"ManagedBy"`
		ManagersInChassis     common.Links `json:"ManagersInChassis"`
		PCIeDevices           common.Links `json:"PCIeDevices"`
		PowerDistribution     common.Link  `json:"PowerDistribution"`
		PowerOutlets          common.Links `json:"PowerOutlets"`
		PowerSupplies         common.Links `json:"PowerSupplies"`
		...
		Storage               common.Links `json:"Storage"`
		Switches              common.Links `json:"Switches"`
	}
	var tmp struct {
		temp
		Actions            cActions
		...
		Controls           common.Link `json:"controls"`
		...
		MediaControllers   common.Link `json:"mediaControllers"`
		Memory             common.Link `json:"memory"`
		MemoryDomains      common.Link `json:"memoryDomains"`
		NetworkAdapters    common.Link `json:"networkAdapters"`
		PCIeDevices        common.Link `json:"pCIeDevices"`
		PCIeSlots          common.Link `json:"pCIeSlots"`
		Power              common.Link `json:"power"`
		PowerSubsystem     common.Link `json:"powerSubsystem"`
		Processors         common.Link `json:"processors"`
		Sensors            common.Link `json:"sensors"`
		Thermal            common.Link `json:"thermal"`
		ThermalSubsystem   common.Link `json:"thermalSubsystem"`
		TrustedComponents  common.Link `json:"trustedComponents"`
	}
	...
	*c = Chassis(tmp.temp)
	...
	c.linkedProcessors = tmp.Links.Processors.ToStrings()
...
func (c *Chassis) GetSupportedResetTypes() ([]common.ResetType, error) {
...
// Reset shall reset the chassis. Additionally, it may reset systems or
...
func (c *Chassis) Reset(resetType common.ResetType) error {
...
func (c *Chassis) AutomationNodes(client common.Client) ([]*AutomationNode, error) {
	return common.GetObjects[AutomationNode](client, c.automationNodes)
}

// Cables gets the Cables linked resources.
func (c *Chassis) Cables(client common.Client) ([]*Cable, error) {
	return common.GetObjects[Cable](client, c.cables)
}

// ComputerSystems gets the ComputerSystems linked resources.
func (c *Chassis) ComputerSystems(client common.Client) ([]*ComputerSystem, error) {
	return common.GetObjects[ComputerSystem](client, c.computerSystems)
}

// ConnectedCoolingLoops gets the ConnectedCoolingLoops linked resources.
func (c *Chassis) ConnectedCoolingLoops(client common.Client) ([]*CoolingLoop, error) {
	return common.GetObjects[CoolingLoop](client, c.connectedCoolingLoops)
}

// ContainedBy gets the ContainedBy linked resource.
func (c *Chassis) ContainedBy(client common.Client) (*Chassis, error) {
	if c.containedBy == "" {
		return nil, nil
	}
	return common.GetObject[Chassis](client, c.containedBy)
}

// Contains gets the Contains linked resources.
func (c *Chassis) Contains(client common.Client) ([]*Chassis, error) {
	return common.GetObjects[Chassis](client, c.contains)
}

// CooledBy gets the CooledBy linked resources.
func (c *Chassis) CooledBy(client common.Client) ([]*common.Entity, error) {
	return common.GetObjects[common.Entity](client, c.cooledBy)
}

// CoolingUnits gets the CoolingUnits linked resources.
func (c *Chassis) CoolingUnits(client common.Client) ([]*CoolingUnit, error) {
	return common.GetObjects[CoolingUnit](client, c.coolingUnits)
}
...
func (c *Chassis) Drives() ([]*Drive, error) {
	...
	// direct property.
	if c.drives != "" {
		return common.GetCollectionObjects[Drive](c.GetClient(), c.drives)
	}

	if len(c.linkedDrives) > 0 {
		return common.GetObjects[Drive](c.GetClient(), c.linkedDrives)
	}
...
func (c *Chassis) EnvironmentMetrics() (*EnvironmentMetrics, error) {
	...
	return GetEnvironmentMetrics(c.GetClient(), c.environmentMetrics)
}

// Facility gets the Facility linked resource.
func (c *Chassis) Facility(client common.Client) (*Facility, error) {
	if c.facility == "" {
		return nil, nil
	}
...
func (c *Chassis) Fans(client common.Client) ([]*Fan, error) {
	return common.GetObjects[Fan](client, c.fans)
}

// ManagedBy gets the ManagedBy linked resources.
func (c *Chassis) ManagedBy(client common.Client) ([]*Manager, error) {
	return common.GetObjects[Manager](client, c.managedBy)
}

// ManagersInChassis gets the ManagersInChassis linked resources.
func (c *Chassis) ManagersInChassis(client common.Client) ([]*Manager, error) {
	return common.GetObjects[Manager](client, c.managersInChassis)
}

// PCIeDevices gets the PCIeDevices linked resources.
func (c *Chassis) PCIeDevices(client common.Client) ([]*PCIeDevice, error) {
	if c.pcieDevices != "" {
		return common.GetCollectionObjects[PCIeDevice](c.GetClient(), c.pcieDevices)
	}

	if len(c.linkedPCIeDevices) > 0 {
		return common.GetObjects[PCIeDevice](c.GetClient(), c.linkedPCIeDevices)
	}
...
func (c *Chassis) PCIeSlots() (*PCIeSlots, error) {
	...
	return GetPCIeSlots(c.GetClient(), c.pcieSlots)
}

// PowerDistribution gets the PowerDistribution linked resource.
func (c *Chassis) PowerDistribution(client common.Client) (*PowerDistribution, error) {
	if c.powerDistribution == "" {
		return nil, nil
	}
	return common.GetObject[PowerDistribution](client, c.powerDistribution)
}

// PowerOutlets gets the PowerOutlets linked resources.
func (c *Chassis) PowerOutlets(client common.Client) ([]*Outlet, error) {
	return common.GetObjects[Outlet](client, c.powerOutlets)
}

// PowerSupplies gets the PowerSupplies linked resources.
func (c *Chassis) PowerSupplies(client common.Client) ([]*PowerSupply, error) {
	return common.GetObjects[PowerSupply](client, c.powerSupplies)
}

// PoweredBy gets the PoweredBy linked resources.
func (c *Chassis) PoweredBy(client common.Client) ([]*common.Entity, error) {
	return common.GetObjects[common.Entity](client, c.poweredBy)
}

// Processors gets the Processors linked resources.
func (c *Chassis) Processors(client common.Client) ([]*Processor, error) {
	if c.processors != "" {
		return common.GetCollectionObjects[Processor](c.GetClient(), c.processors)
	}

	if len(c.linkedProcessors) > 0 {
		return common.GetObjects[Processor](c.GetClient(), c.linkedProcessors)
	}
...
func (c *Chassis) ResourceBlocks(client common.Client) ([]*ResourceBlock, error) {
	return common.GetObjects[ResourceBlock](client, c.resourceBlocks)
}

// Storage gets the Storage linked resources.
func (c *Chassis) Storage(client common.Client) ([]*Storage, error) {
	return common.GetObjects[Storage](client, c.storage)
}

// Switches gets the Switches linked resources.
func (c *Chassis) Switches(client common.Client) ([]*Switch, error) {
	return common.GetObjects[Switch](client, c.switches)
}

// Assembly gets the Assembly linked resource.
func (c *Chassis) Assembly(client common.Client) (*Assembly, error) {
	if c.assembly == "" {
		return nil, nil
	}
...
func (c *Chassis) Certificates(client common.Client) ([]*Certificate, error) {
	if c.certificates == "" {
		return nil, nil
	}
...
func (c *Chassis) Controls(client common.Client) ([]*Control, error) {
	if c.controls == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[Control](client, c.controls)
}

// FabricAdapters gets the FabricAdapters collection.
func (c *Chassis) FabricAdapters(client common.Client) ([]*FabricAdapter, error) {
	if c.fabricAdapters == "" {
		return nil, nil
	}
...
func (c *Chassis) LeakDetectors(client common.Client) ([]*LeakDetector, error) {
	if c.leakDetectors == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[LeakDetector](client, c.leakDetectors)
}

// LogServices gets the LogServices collection.
func (c *Chassis) LogServices(client common.Client) ([]*LogService, error) {
	if c.logServices == "" {
		return nil, nil
	}
...
func (c *Chassis) MediaControllers(client common.Client) ([]*MediaController, error) {
	if c.mediaControllers == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[MediaController](client, c.mediaControllers)
}

// Memory gets the Memory collection.
func (c *Chassis) Memory(client common.Client) ([]*Memory, error) {
	if c.memory == "" {
		return nil, nil
	}
...
func (c *Chassis) MemoryDomains(client common.Client) ([]*MemoryDomain, error) {
	if c.memoryDomains == "" {
		return nil, nil
	}
...
func (c *Chassis) NetworkAdapters(client common.Client) ([]*NetworkAdapter, error) {
	if c.networkAdapters == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[NetworkAdapter](client, c.networkAdapters)
}

// Power gets the Power linked resource.
func (c *Chassis) Power(client common.Client) (*Power, error) {
	if c.power == "" {
		return nil, nil
	}
	return common.GetObject[Power](client, c.power)
}

// PowerSubsystem gets the PowerSubsystem linked resource.
func (c *Chassis) PowerSubsystem(client common.Client) (*PowerSubsystem, error) {
	if c.powerSubsystem == "" {
		return nil, nil
	}
	return common.GetObject[PowerSubsystem](client, c.powerSubsystem)
}

// Sensors gets the Sensors collection.
func (c *Chassis) Sensors(client common.Client) ([]*Sensor, error) {
	if c.sensors == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[Sensor](client, c.sensors)
}

// Thermal gets the Thermal linked resource.
func (c *Chassis) Thermal(client common.Client) (*Thermal, error) {
	if c.thermal == "" {
		return nil, nil
	}
	return common.GetObject[Thermal](client, c.thermal)
}

// ThermalSubsystem gets the ThermalSubsystem linked resource.
func (c *Chassis) ThermalSubsystem(client common.Client) (*ThermalSubsystem, error) {
	if c.thermalSubsystem == "" {
		return nil, nil
	}
	return common.GetObject[ThermalSubsystem](client, c.thermalSubsystem)
}

// TrustedComponents gets the TrustedComponents collection.
func (c *Chassis) TrustedComponents(client common.Client) ([]*TrustedComponent, error) {
	if c.trustedComponents == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[TrustedComponent](client, c.trustedComponents)
}

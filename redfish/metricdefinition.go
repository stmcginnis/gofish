...
const (
	...
	SummationCalculationAlgorithmEnum CalculationAlgorithmEnum = "Summation" // From metricreportdefinition
)

type ImplementationType string

const (
	// PhysicalSensorImplementationType The metric is implemented as a physical
	// sensor.
	PhysicalSensorImplementationType ImplementationType = "PhysicalSensor"
	// CalculatedImplementationType The metric is implemented by applying a
	...
	// SynthesizedImplementationType The metric is implemented by applying a
...
type MetricDefinition struct {
	...
	// present if 'ImplementationType' contains 'Synthesized' or 'Calculated'.
	...
	Wildcards []MetricDefinitionWildcard
...
// MetricDefinitionWildcard shall contain a wildcard and its substitution values.
type MetricDefinitionWildcard struct {

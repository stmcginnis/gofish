...
func (m *MemoryChunks) UnmarshalJSON(b []byte) error {
	...
	type mLinks struct {
		...
		MemoryRegions     common.Links `json:"MemoryRegions"`
	}
	var tmp struct {
		temp
		Links mLinks
...
func (m *MemoryChunks) CXLLogicalDevices(client common.Client) ([]*CXLLogicalDevice, error) {
	return common.GetObjects[CXLLogicalDevice](client, m.cXLLogicalDevices)
}

// Endpoints gets the Endpoints linked resources.
func (m *MemoryChunks) Endpoints(client common.Client) ([]*Endpoint, error) {
	return common.GetObjects[Endpoint](client, m.endpoints)
}

// MemoryRegions gets the MemoryRegions linked resources.
func (m *MemoryChunks) MemoryRegions(client common.Client) ([]*MemoryRegion, error) {
	return common.GetObjects[MemoryRegion](client, m.memoryRegions)
}
...
func (i *InterleaveSet) Memory(client common.Client) (*common.Entity, error) {
	if i.memory == "" {
		return nil, nil
	}
	return common.GetObject[common.Entity](client, i.memory)
}

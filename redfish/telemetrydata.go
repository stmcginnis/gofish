...
func GetTelemetryData(c common.Client, uri string) (*TelemetryData, error) {
	return common.GetObject[TelemetryData](c, uri)
}

// ListReferencedTelemetryDatas gets the collection of TelemetryData from
// a provided reference.
func ListReferencedTelemetryDatas(c common.Client, link string) ([]*TelemetryData, error) {
	return common.GetCollectionObjects[TelemetryData](c, link)
}

...
func (m *ManagerDiagnosticData) Update() error {
...
// ResetMetrics shall reset any time intervals or counted values of the
// diagnostic data for this manager.
func (m *ManagerDiagnosticData) ResetMetrics() error {
	payload := make(map[string]any)
	return m.Post(m.resetMetricsTarget, payload)
}

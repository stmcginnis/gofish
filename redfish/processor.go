...
//
// 2025.3 - #Processor.v1_21_0.Processor
...
func (p *Processor) UnmarshalJSON(b []byte) error {
	...
	type pActions struct {
		Reset           common.ActionTarget `json:"#Processor.Reset"`
		ResetToDefaults common.ActionTarget `json:"#Processor.ResetToDefaults"`
	}
	type pLinks struct {
		Chassis                common.Link  `json:"Chassis"`
		ConnectedProcessors    common.Links `json:"ConnectedProcessors"`
		Endpoints              common.Links `json:"Endpoints"`
		FabricAdapters         common.Links `json:"FabricAdapters"`
		GraphicsController     common.Link  `json:"GraphicsController"`
	...
	var tmp struct {
		...
		Actions                pActions
		Links                  pLinks
		AccelerationFunctions  common.Link `json:"accelerationFunctions"`
		AppliedOperatingConfig common.Link `json:"appliedOperatingConfig"`
		Assembly               common.Link `json:"assembly"`
		CacheMemory            common.Link `json:"cacheMemory"`
		...
		OperatingConfigs       common.Link `json:"operatingConfigs"`
		Ports                  common.Link `json:"ports"`
		SubProcessors          common.Link `json:"subProcessors"`
...
// Reset shall reset the processor.
...
func (p *Processor) Reset(resetType common.ResetType) error {
	payload := make(map[string]any)
	payload["ResetType"] = resetType
	return p.Post(p.resetTarget, payload)
}
...
func (p *Processor) ResetToDefaults() error {
	payload := make(map[string]any)
	return p.Post(p.resetToDefaultsTarget, payload)
}

// Chassis gets the Chassis linked resource.
func (p *Processor) Chassis(client common.Client) (*Chassis, error) {
	if p.chassis == "" {
		return nil, nil
	}
	return common.GetObject[Chassis](client, p.chassis)
}

// ConnectedProcessors gets the ConnectedProcessors linked resources.
func (p *Processor) ConnectedProcessors(client common.Client) ([]*Processor, error) {
	return common.GetObjects[Processor](client, p.connectedProcessors)
}

// Endpoints gets the Endpoints linked resources.
func (p *Processor) Endpoints(client common.Client) ([]*Endpoint, error) {
	return common.GetObjects[Endpoint](client, p.endpoints)
}

// FabricAdapters gets the FabricAdapters linked resources.
func (p *Processor) FabricAdapters(client common.Client) ([]*FabricAdapter, error) {
	return common.GetObjects[FabricAdapter](client, p.fabricAdapters)
}

// GraphicsController gets the GraphicsController linked resource.
func (p *Processor) GraphicsController(client common.Client) (*GraphicsController, error) {
	if p.graphicsController == "" {
		return nil, nil
	}
	return common.GetObject[GraphicsController](client, p.graphicsController)
}

// Memory gets the Memory linked resources.
func (p *Processor) Memory(client common.Client) ([]*Memory, error) {
	return common.GetObjects[Memory](client, p.memory)
}

// NetworkDeviceFunctions gets the NetworkDeviceFunctions linked resources.
func (p *Processor) NetworkDeviceFunctions(client common.Client) ([]*NetworkDeviceFunction, error) {
...
func (p *Processor) PCIeDevice(client common.Client) (*PCIeDevice, error) {
	if p.pCIeDevice == "" {
		return nil, nil
	}
...
func (p *Processor) PCIeFunctions(client common.Client) ([]*PCIeFunction, error) {
	return common.GetObjects[PCIeFunction](client, p.pCIeFunctions)
}

// AccelerationFunctions gets the AccelerationFunctions collection.
func (p *Processor) AccelerationFunctions(client common.Client) ([]*AccelerationFunction, error) {
	if p.accelerationFunctions == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[AccelerationFunction](client, p.accelerationFunctions)
}

// AppliedOperatingConfig gets the AppliedOperatingConfig linked resource.
func (p *Processor) AppliedOperatingConfig(client common.Client) (*OperatingConfig, error) {
	if p.appliedOperatingConfig == "" {
		return nil, nil
	}
	return common.GetObject[OperatingConfig](client, p.appliedOperatingConfig)
}

// Assembly gets the Assembly linked resource.
func (p *Processor) Assembly(client common.Client) (*Assembly, error) {
	if p.assembly == "" {
		return nil, nil
	}
...
func (p *Processor) CacheMemory(client common.Client) ([]*Memory, error) {
	if p.cacheMemory == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[Memory](client, p.cacheMemory)
}

// Certificates gets the Certificates collection.
func (p *Processor) Certificates(client common.Client) ([]*Certificate, error) {
	if p.certificates == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[Certificate](client, p.certificates)
}

// EnvironmentMetrics gets the EnvironmentMetrics linked resource.
func (p *Processor) EnvironmentMetrics(client common.Client) (*EnvironmentMetrics, error) {
	if p.environmentMetrics == "" {
		return nil, nil
	}
	return common.GetObject[EnvironmentMetrics](client, p.environmentMetrics)
}

// Metrics gets the Metrics linked resource.
func (p *Processor) Metrics(client common.Client) (*ProcessorMetrics, error) {
	if p.metrics == "" {
		return nil, nil
	}
...
func (p *Processor) OperatingConfigs(client common.Client) ([]*OperatingConfig, error) {
	if p.operatingConfigs == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[OperatingConfig](client, p.operatingConfigs)
}

// Ports gets the Ports collection.
func (p *Processor) Ports(client common.Client) ([]*Port, error) {
	if p.ports == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[Port](client, p.ports)
}

// SubProcessors gets the SubProcessors collection.
func (p *Processor) SubProcessors(client common.Client) ([]*Processor, error) {
	if p.subProcessors == "" {
		return nil, nil
	}
	return common.GetCollectionObjects[Processor](client, p.subProcessors)
}
...
func (f *FpgaReconfigurationSlot) UnmarshalJSON(b []byte) error {
	...
	var tmp struct {
		temp
		AccelerationFunction common.Link `json:"accelerationFunction"`
	}
...
func (f *FpgaReconfigurationSlot) AccelerationFunction(client common.Client) (*AccelerationFunction, error) {
	if f.accelerationFunction == "" {
		return nil, nil
	}
	return common.GetObject[AccelerationFunction](client, f.accelerationFunction)
}
...
// Metrics gets the Metrics linked resource.
func (m *MemorySummary) Metrics(client common.Client) (*MemoryMetrics, error) {
	if m.metrics == "" {
		return nil, nil
	}

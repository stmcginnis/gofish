...
func (l *LicenseService) Install(authorizedDevices []string, licenseFileURI string, password string, targetServices []string, transferProtocol TransferProtocolType, username string) (*TaskMonitorInfo, error) {
	...
	resp, taskInfo, err := PostWithTask(l.client,
		l.installTarget, payload, l.Headers(), false)

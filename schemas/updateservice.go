...
// scheduled with the 'OperationUpdateServiceApplyTime' value of 'OnStartUpdateRequest'.
//
// If TaskMonitorInfo is not nil it can be used to monitor async tasks.
...
type HTTPPushURIApplyTime struct {
	// UpdateServiceApplyTime shall indicate the time when to apply the 'HttpPushUri'-provided
	// software update.
	//
	// Version added: v1.4.0
	UpdateServiceApplyTime UpdateServiceApplyTime
	...
	// the 'HttpPushUriUpdateServiceApplyTime' property value is 'AtMaintenanceWindowStart' or
	...
	// 'HttpPushUriUpdateServiceApplyTime' property value is 'AtMaintenanceWindowStart' or
	// 'InMaintenanceWindowOnReset'.
	//
	// Version added: v1.4.0
...
type HTTPPushURIOptions struct {
	...
	//
	// Version added: v1.4.0
	HTTPPushURIApplyTime HTTPPushURIApplyTime `json:"HttpPushUriUpdateServiceApplyTime"`
}

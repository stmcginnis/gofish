...
func (j *JobDocument) SubmitJob(hidePayload bool, jobCreator string, parameters []any, preferredExecutors []string, startTime string) (*TaskMonitorInfo, error) {
	...
	resp, taskInfo, err := PostWithTask(j.client,
		j.submitJobTarget, payload, j.Headers(), false)

...
// http://redfish.dmtf.org/schemas/v1/Outlet.v1_4_4.json
...
func (o *Outlet) PowerControl(powerState OutletPowerState) (*TaskMonitorInfo, error) {
	...
	resp, taskInfo, err := PostWithTask(o.client,
		o.powerControlTarget, payload, o.ActionHeaders(o.powerControlTarget), false)
...
func (o *Outlet) ResetMetrics() (*TaskMonitorInfo, error) {
	payload := make(map[string]any)
	resp, taskInfo, err := PostWithTask(o.client,
		o.resetMetricsTarget, payload, o.ActionHeaders(o.resetMetricsTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}

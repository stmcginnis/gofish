...
func (a *AutomationNode) Reset() (*TaskMonitorInfo, error) {
	...
	resp, taskInfo, err := PostWithTask(a.client,
		a.resetTarget, payload, a.ActionHeaders(a.resetTarget), false)
...
func (a *AutomationNode) SendTrigger() (*TaskMonitorInfo, error) {
	payload := make(map[string]any)
	resp, taskInfo, err := PostWithTask(a.client,
		a.sendTriggerTarget, payload, a.ActionHeaders(a.sendTriggerTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (a *AutomationNode) Start() (*TaskMonitorInfo, error) {
	payload := make(map[string]any)
	resp, taskInfo, err := PostWithTask(a.client,
		a.startTarget, payload, a.ActionHeaders(a.startTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (a *AutomationNode) Stop() (*TaskMonitorInfo, error) {
	payload := make(map[string]any)
	resp, taskInfo, err := PostWithTask(a.client,
		a.stopTarget, payload, a.ActionHeaders(a.stopTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (a *AutomationNode) Wait() (*TaskMonitorInfo, error) {
	payload := make(map[string]any)
	resp, taskInfo, err := PostWithTask(a.client,
		a.waitTarget, payload, a.ActionHeaders(a.waitTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}

...
func (m *Memory) DisableMasterPassphrase(passphrase string, regionID string) (*TaskMonitorInfo, error) {
	...
	resp, taskInfo, err := PostWithTask(m.client,
		m.disableMasterPassphraseTarget, payload, m.ActionHeaders(m.disableMasterPassphraseTarget), false)
...
func (m *Memory) DisablePassphrase(passphrase string, regionID string) (*TaskMonitorInfo, error) {
	...
	payload["RegionId"] = regionID
	resp, taskInfo, err := PostWithTask(m.client,
		m.disablePassphraseTarget, payload, m.ActionHeaders(m.disablePassphraseTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (m *Memory) FreezeSecurityState() (*TaskMonitorInfo, error) {
	payload := make(map[string]any)
	resp, taskInfo, err := PostWithTask(m.client,
		m.freezeSecurityStateTarget, payload, m.ActionHeaders(m.freezeSecurityStateTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (m *Memory) InjectPersistentPoison(physicalAddress string) (*TaskMonitorInfo, error) {
	...
	resp, taskInfo, err := PostWithTask(m.client,
		m.injectPersistentPoisonTarget, payload, m.ActionHeaders(m.injectPersistentPoisonTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (m *Memory) OverwriteUnit(passphrase string, regionID string) (*TaskMonitorInfo, error) {
	...
	payload["RegionId"] = regionID
	resp, taskInfo, err := PostWithTask(m.client,
		m.overwriteUnitTarget, payload, m.ActionHeaders(m.overwriteUnitTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (m *Memory) ScanMedia(length int, noEventLog bool, physicalAddress string) (*TaskMonitorInfo, error) {
	...
	payload["PhysicalAddress"] = physicalAddress
	resp, taskInfo, err := PostWithTask(m.client,
		m.scanMediaTarget, payload, m.ActionHeaders(m.scanMediaTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (m *Memory) SecureEraseUnit(passphrase string, regionID string) (*TaskMonitorInfo, error) {
	...
	payload["RegionId"] = regionID
	resp, taskInfo, err := PostWithTask(m.client,
		m.secureEraseUnitTarget, payload, m.ActionHeaders(m.secureEraseUnitTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (m *Memory) SetMasterPassphrase(passphrase string, regionID string) (*TaskMonitorInfo, error) {
	...
	payload["RegionId"] = regionID
	resp, taskInfo, err := PostWithTask(m.client,
		m.setMasterPassphraseTarget, payload, m.ActionHeaders(m.setMasterPassphraseTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (m *Memory) SetPassphrase(passphrase string, regionID string) (*TaskMonitorInfo, error) {
	...
	payload["RegionId"] = regionID
	resp, taskInfo, err := PostWithTask(m.client,
		m.setPassphraseTarget, payload, m.ActionHeaders(m.setPassphraseTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (m *Memory) UnlockUnit(passphrase string, regionID string) (*TaskMonitorInfo, error) {
	...
	payload["RegionId"] = regionID
	resp, taskInfo, err := PostWithTask(m.client,
		m.unlockUnitTarget, payload, m.ActionHeaders(m.unlockUnitTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}

...
func initLogServiceClient(t *testing.T, template string) (*LogService, *TestClient) {
	var result LogService
...
func TestLogServiceCollectDiagnosticsDataSuccess(t *testing.T) {
	...
	location, _, err := logSvc.CollectDiagnosticData(&LogServiceCollectDiagnosticDataParameters{

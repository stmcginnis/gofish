...
func (c *CoolingUnit) ExportConfiguration(components []Component, encryptionPassphrase string, exportType ExportType, oEMComponents []string, security ExportSecurity) (*TaskMonitorInfo, error) {

...
func (ba *Battery) Calibrate() (*TaskMonitorInfo, error) {
	...
	resp, taskInfo, err := PostWithTask(ba.client,
		ba.calibrateTarget, payload, ba.ActionHeaders(ba.calibrateTarget), false)
...
func (ba *Battery) Reset(resetType ResetType) (*TaskMonitorInfo, error) {
	...
	resp, taskInfo, err := PostWithTask(ba.client,
		ba.resetTarget, payload, ba.ActionHeaders(ba.resetTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (ba *Battery) SelfTest() (*TaskMonitorInfo, error) {
	payload := make(map[string]any)
	resp, taskInfo, err := PostWithTask(ba.client,
		ba.selfTestTarget, payload, ba.ActionHeaders(ba.selfTestTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}

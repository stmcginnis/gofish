...
func (v *Volume) AssignReplicaTarget(replicaType ReplicaType, replicaUpdateMode ReplicaUpdateMode, targetVolume string) (*TaskMonitorInfo, error) {
	...
	resp, taskInfo, err := PostWithTask(v.client,
		v.assignReplicaTargetTarget, payload, v.ActionHeaders(v.assignReplicaTargetTarget), false)
...
func (v *Volume) ChangeRAIDLayout(params *VolumeChangeRAIDLayoutParameters) (*TaskMonitorInfo, error) {
	resp, taskInfo, err := PostWithTask(v.client,
		v.changeRAIDLayoutTarget, params, v.ActionHeaders(v.changeRAIDLayoutTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (v *Volume) CheckConsistency() (*TaskMonitorInfo, error) {
	payload := make(map[string]any)
	resp, taskInfo, err := PostWithTask(v.client,
		v.checkConsistencyTarget, payload, v.ActionHeaders(v.checkConsistencyTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (v *Volume) CreateReplicaTarget(params *VolumeCreateReplicaTargetParameters) (*TaskMonitorInfo, error) {
	resp, taskInfo, err := PostWithTask(v.client,
		v.createReplicaTargetTarget, params, v.ActionHeaders(v.createReplicaTargetTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (v *Volume) ForceEnable() (*TaskMonitorInfo, error) {
	payload := make(map[string]any)
	resp, taskInfo, err := PostWithTask(v.client,
		v.forceEnableTarget, payload, v.ActionHeaders(v.forceEnableTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (v *Volume) Initialize(initializeMethod InitializeMethod, initializeType InitializeType) (*TaskMonitorInfo, error) {
	...
	resp, taskInfo, err := PostWithTask(v.client,
		v.initializeTarget, payload, v.ActionHeaders(v.initializeTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (v *Volume) RemoveReplicaRelationship(deleteTargetVolume bool, targetVolume string) (*TaskMonitorInfo, error) {
	...
	payload["TargetVolume"] = targetVolume
	resp, taskInfo, err := PostWithTask(v.client,
		v.removeReplicaRelationshipTarget, payload, v.ActionHeaders(v.removeReplicaRelationshipTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (v *Volume) ResumeReplication(targetVolume string) (*TaskMonitorInfo, error) {
	...
	payload["TargetVolume"] = targetVolume
	resp, taskInfo, err := PostWithTask(v.client,
		v.resumeReplicationTarget, payload, v.ActionHeaders(v.resumeReplicationTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (v *Volume) ReverseReplicationRelationship(targetVolume string) (*TaskMonitorInfo, error) {
	...
	payload["TargetVolume"] = targetVolume
	resp, taskInfo, err := PostWithTask(v.client,
		v.reverseReplicationRelationshipTarget, payload, v.ActionHeaders(v.reverseReplicationRelationshipTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (v *Volume) SplitReplication(targetVolume string) (*TaskMonitorInfo, error) {
	...
	payload["TargetVolume"] = targetVolume
	resp, taskInfo, err := PostWithTask(v.client,
		v.splitReplicationTarget, payload, v.ActionHeaders(v.splitReplicationTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (v *Volume) SuspendReplication(targetVolume string) (*TaskMonitorInfo, error) {
	...
	payload["TargetVolume"] = targetVolume
	resp, taskInfo, err := PostWithTask(v.client,
		v.suspendReplicationTarget, payload, v.ActionHeaders(v.suspendReplicationTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}

...
func (s *StoragePool) AddDrives(capacitySource string, drives []string) (*TaskMonitorInfo, error) {
	...
	resp, taskInfo, err := PostWithTask(s.client,
		s.addDrivesTarget, payload, s.ActionHeaders(s.addDrivesTarget), false)
...
func (s *StoragePool) RemoveDrives(drives []string) (*TaskMonitorInfo, error) {
	...
	payload["Drives"] = drives
	resp, taskInfo, err := PostWithTask(s.client,
		s.removeDrivesTarget, payload, s.ActionHeaders(s.removeDrivesTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (s *StoragePool) SetCompressionState(enable bool) (*TaskMonitorInfo, error) {
	...
	resp, taskInfo, err := PostWithTask(s.client,
		s.setCompressionStateTarget, payload, s.ActionHeaders(s.setCompressionStateTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (s *StoragePool) SetDeduplicationState(enable bool) (*TaskMonitorInfo, error) {
	...
	payload["Enable"] = enable
	resp, taskInfo, err := PostWithTask(s.client,
		s.setDeduplicationStateTarget, payload, s.ActionHeaders(s.setDeduplicationStateTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (s *StoragePool) SetEncryptionState(enable bool) (*TaskMonitorInfo, error) {
	...
	payload["Enable"] = enable
	resp, taskInfo, err := PostWithTask(s.client,
		s.setEncryptionStateTarget, payload, s.ActionHeaders(s.setEncryptionStateTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}

...
// http://redfish.dmtf.org/schemas/v1/Job.v1_3_0.json
...
func (j *Job) Cancel() (*TaskMonitorInfo, error) {
	...
	resp, taskInfo, err := PostWithTask(j.client,
		j.cancelTarget, payload, j.ActionHeaders(j.cancelTarget), false)
...
func (j *Job) ForceStart() (*TaskMonitorInfo, error) {
	payload := make(map[string]any)
	resp, taskInfo, err := PostWithTask(j.client,
		j.forceStartTarget, payload, j.ActionHeaders(j.forceStartTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (j *Job) Invalidate() (*TaskMonitorInfo, error) {
	payload := make(map[string]any)
	resp, taskInfo, err := PostWithTask(j.client,
		j.invalidateTarget, payload, j.ActionHeaders(j.invalidateTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (j *Job) Resubmit(startTime string) (*TaskMonitorInfo, error) {
	...
	resp, taskInfo, err := PostWithTask(j.client,
		j.resubmitTarget, payload, j.ActionHeaders(j.resubmitTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (j *Job) Resume() (*TaskMonitorInfo, error) {
	payload := make(map[string]any)
	resp, taskInfo, err := PostWithTask(j.client,
		j.resumeTarget, payload, j.ActionHeaders(j.resumeTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (j *Job) Suspend() (*TaskMonitorInfo, error) {
	payload := make(map[string]any)
	resp, taskInfo, err := PostWithTask(j.client,
		j.suspendTarget, payload, j.ActionHeaders(j.suspendTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
...
func (j *Job) Validate() (*TaskMonitorInfo, error) {
	payload := make(map[string]any)
	resp, taskInfo, err := PostWithTask(j.client,
		j.validateTarget, payload, j.ActionHeaders(j.validateTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}

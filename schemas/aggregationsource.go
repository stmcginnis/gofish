...
// http://redfish.dmtf.org/schemas/v1/AggregationSource.v1_5_0.json
...
func (a *AggregationSource) GenerateSSHIdentityKeyPair(curve ECDSACurveType, keyLength int, keyType SSHAlgoKeyType) (*TaskMonitorInfo, error) {
	...
	resp, taskInfo, err := PostWithTask(a.client,
		a.generateSSHIdentityKeyPairTarget, payload, a.ActionHeaders(a.generateSSHIdentityKeyPairTarget), false)
...
func (a *AggregationSource) RemoveSSHIdentityKeyPair() (*TaskMonitorInfo, error) {
	payload := make(map[string]any)
	resp, taskInfo, err := PostWithTask(a.client,
		a.removeSSHIdentityKeyPairTarget, payload, a.ActionHeaders(a.removeSSHIdentityKeyPairTarget), false)
	defer DeferredCleanupHTTPResponse(resp)
	return taskInfo, err
}
